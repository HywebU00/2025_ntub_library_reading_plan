          ...
          <div className='topBox'>
            ...
            {categoriesData.map((item) => (
              <div className='searchBox' key={item.categories}>
                ...
                <SearchCheckBox type={categoryToTypeMap.get(item.categories)} dataset={item.sub_categories} selectedFilters={selectedFilters} onFilterChange={(filterValue) => handleFilterChange(filterValue, item.categories)} />
              </div>
            ))}
